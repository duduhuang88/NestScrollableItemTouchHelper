...
package com.duduhuang88.demo.helper;
 ...
 * {@link Callback} class or implementing {@link ItemTouchHelper.ViewDropHandler}
 ...
 */
public class NestScrollableItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    public NestScrollableItemTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
     ...
     * mRecyclerView的可见区域
     */
    private Rect mRecyclerviewGlobalVisibleRect = new Rect();
